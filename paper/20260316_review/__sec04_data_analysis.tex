...
\textcolor{red}{The temperature behavior visible in Figure \ref{fig:voltage_current_temperature} is consistent with heat generation under load: temperature increases during high-current charge/discharge intervals and relaxes during rest/CV segments. This supports the interpretation that thermal response is coupled to current intensity and energy throughput (Joule-heating dominated), while still requiring caution because thermocouple-contact issues can introduce measurement uncertainty.}
