...
\begin{enumerate}
    ...
    \item \textbf{Differential Entropy:} A measure of signal randomness, computed only for voltage due to infinite values arising in current and temperature calculations, possibly from near-constant segments or noise. \todo[size=\tiny]{[R1] Authors should explain why diff-entropy is important.}
\end{enumerate}
